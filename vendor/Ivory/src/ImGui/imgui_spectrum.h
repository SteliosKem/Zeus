...
namespace ImGui {
    namespace Spectrum {
        ...
        namespace Static { // static colors
            ...
            const unsigned int GRAY200 = Color(0x2E2E2E);
            const unsigned int GRAY300 = Color(0x2E2E2E);
            const unsigned int GRAY400 = Color(0x333333);
            const unsigned int GRAY500 = Color(0x333333);
            const unsigned int GRAY600 = Color(0x3E3E3E);
            const unsigned int GRAY700 = Color(0x3E3E3E);
            const unsigned int GRAY800 = Color(0x2E2E2E);
            const unsigned int GRAY900 = Color(0x2E2E2E);
